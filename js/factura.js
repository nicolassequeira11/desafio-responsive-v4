...
function imprimirTicket() {
  ...
  doc.text(80, 35, 'Cliente:');
  doc.text(100, 35, cliente.value);
  doc.text(80, 40, 'RUT:');
  doc.text(100, 40, rut.value);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  btnImprimir.addEventListener("click", () => {
    if(cliente.value.trim() === ""){
      ...
      alert("No se puede imprimir si total es NaN, agrega cantidades a su producto.");
